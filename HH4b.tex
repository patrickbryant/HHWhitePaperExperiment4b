...
\label{sec:HH4b}
The plurality of \hh events decay via the \bbbb channel ensuring searches in the four \bjet final state dominant sensitivity above some \mhh threshold.
...
\begin{figure}
  \begin{center}
    ...
    \subfloat[2018 Analysis \cite{Bryant:2644551}%% \bf{UPDATE WHEN PAPER IS OUT}
